...
require "config.php";
    ...
    if ($result->num_rows > 0){
        $query_delete = "DELETE FROM list_like WHERE id_user = '$id_user' AND id_movie = $id_movie";
        $result_delete= $conn->query($query_delete);
        echo "remove";
    } 
    else
    {
        $query_add = "INSERT INTO list_like(id_movie,id_user) VALUES ('$id_movie','$id_user')";
