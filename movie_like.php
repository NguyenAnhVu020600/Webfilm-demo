...
<div class="container">
    <div class="content-container-new">
        <div class="tray-title">Phim Đã Thích</div>
        <div class="film-list">
            <div class="table-header">
                ...
                FROM movie, list_like ,session, episode
                WHERE movie.id_movie = list_like.id_movie AND movie.id_movie = session.id_movie 
                AND session.id_session = episode.id_session AND list_like.id_user = $id_user
                ...
                ?>
                    <div class="film-item" id="film-id-5916">
                        ...
                        <div class="column column-5 column-tools">
                            <a href="delete_like_movie.php?id_movie=<?=$id_movie?>">
