    ...
    <div class="row">
        ...
        <?php
            ...
            if (isset($_GET['id_movie'])) {
                ...
                header("location:admin_home.php?loadpage=detail_movie.php");
            }

            $id_movie = $_SESSION['id_movie'];
            $query = "SELECT movie.id_movie, movie.name,movie.thumbnail,movie.description,
            general_cate.id_general_cate as 'id_general_cate',
            general_cate.name as 'general_cate',
            country.id_country as 'id_country',
            country.name as 'country'
            FROM movie,general_cate,country
            WHERE general_cate.id_general_cate = movie.id_general_cate 
            AND country.id_country = movie.id_country AND  id_movie = '$id_movie'";
        ...
        <div class="col-sm-4">
            ...
            <img class="thumbnail_movie" src="../Data/thumbnail/<?=$row['thumbnail']?>"/>
            <div class="thumbnail_show">
                <span>Thumbnail</span>
            </div>
        </div>
        <div class="col-sm-8">
        <form method="post" enctype="multipart/form-data" action="action_update_movie.php" >
            ...
            <div class="form-group">
                <a href='action_add_new_movie.php?id_movie=<?=$id_movie?>' class='badge badge-primary p-2'>Thêm vào danh sách phim mới</a>
                <a href='action_add_odd_movie.php?id_movie=<?=$id_movie?>' class='badge badge-primary p-2' style="margin-left:15px;">Thêm vào danh sách phim lẻs</a>
            </div>
