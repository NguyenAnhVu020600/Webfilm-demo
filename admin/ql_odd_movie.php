    ...
    <form method="POST">
        ...
        if (isset($_GET['id']) == '1') {
            if ($_SESSION['role'] == 'admin') {
                ...
                $_SESSION['tieude'] = "Quản lý phim lẻ";
        ...
        if(isset($_POST['search']))
        {
            ...
            $query = "SELECT * FROM movie,odd_movie WHERE movie.id_movie = odd_movie.id_movie 
            AND (odd_movie.id_movie LIKE '%$key%' OR movie.name LIKE '%$key%')";
        ...
        <h3 class="text-center text-info">Danh sách phim lẻ</h3>
        <div class="thongbao">
            <?php
                    ...
                    <tr bgcolor="<?php echo $bg; ?>">
                        ...
                        <?php
                            ...
                            <td style="width:200px;">
                                <a href='detail_odd_movie.php?id_movie=<?=$id_movie?>' class='badge badge-primary p-2'>Xem link</a>
                                <a style='background-color: #fc3232;' href='delete_odd_movie.php?id_movie=<?=$id_movie?>' class='badge badge-primary p-2'>Xóa</a>
                            </td>
                        <?php
                        ?>
                    </tr>
