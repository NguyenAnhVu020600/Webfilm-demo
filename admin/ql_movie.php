    ...
    <form method="POST">
        ...
        if (isset($_GET['id']) == '1') {
            if ($_SESSION['role'] == 'admin') {
                ...
                $_SESSION['tieude'] = "Quản lý phim ảnh";
        ...
        {
            $key = $_POST['name'];
            $query = "SELECT * FROM movie WHERE id_movie LIKE '%$key%' OR name LIKE '%$key%'";
        ...
        <div class="form-group">
            <a href='add_movie.php?id=1' class="btn btn-primary btn-block">Thêm phim mới</a>
        </div>
        <div class="thongbao">
            <?php
                    ...
                    <tr bgcolor="<?php echo $bg; ?>">
                        ...
                        <?php
                            ...
                            <td style="width:130px;">
                                <a href='detail_movie.php?id_movie=<?=$id_movie?>' class='badge badge-primary p-2'>Chi tiết</a>
